...
const {
  ...
  ExceptionDetails,
} = require('selenium-webdriver/bidi/evaluateResult')
const { RealmInfo } = require('selenium-webdriver/bidi/realmInfo')
const { RemoteValue } = require('selenium-webdriver/bidi/protocolValue')
