...
const { InvalidArgumentError, NoSuchFrameError } = require('selenium-webdriver/lib/error')
const { BrowsingContextInfo } = require('selenium-webdriver/bidi/browsingContextTypes')
