...
async function disable2FA() {
	try {
		...
		const response = await fetch("http://localhost:443/set_2fa/", {
			method: "POST",
			headers: {
				"Content-Type": "application/json",
			},
...
async function sendEnable2faEmail(otp, email) {
	const response = await fetch("http://localhost:443/enable_2fa_email/", {
		method: "POST",
		headers: {
			"Content-Type": "application/json",
		},
...
async function submit2FaEmail(email) {
	const response = await fetch("http://localhost:443/submit_2fa_email/", {
		method: "POST",
		headers: {
			"Content-Type": "application/json",
		},
