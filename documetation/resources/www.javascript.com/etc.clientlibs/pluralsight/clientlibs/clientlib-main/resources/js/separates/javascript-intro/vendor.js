! function(global, factory) {
    ...
    jQuery.Animation = jQuery.extend(Animation, {
            ...
            return opt.duration = jQuery.fx.off ? 0 : "number" == typeof opt.duration ? opt.duration : opt.duration in jQuery.fx.speeds ? jQuery.fx.speeds[opt.duration] : jQuery.fx.speeds._default,
                null != opt.queue && opt.queue !== !0 || (opt.queue = "fx"), opt.old = opt.complete, opt.complete = function() {
    ...
    Tooltip.VERSION = "3.3.7", Tooltip.TRANSITION_DURATION = 150, Tooltip.DEFAULTS = {
        ...
        /* note - this function overridden from default due to erratic behavior */
        function complete() {
...
function(global, factory) {
    ...
    function assign(ta) {
        ...
        function changeOverflow(value) {
            ...
            ta.style.width = "0px", ta.offsetWidth, ta.style.width = width, ta.style.overflowY = value
        }
        ...
        if (ta && ta.nodeName && "TEXTAREA" === ta.nodeName && !map.has(ta)) {
            var heightOffset = null,
                ...
                destroy = function(style) {
                    window.removeEventListener("resize", pageResize, !1), ta.removeEventListener("input", update, !1), ta.removeEventListener("keyup", update, !1), ta.removeEventListener("autosize:destroy", destroy, !1), ta.removeEventListener("autosize:update", update, !1), Object.keys(style).forEach(function(key) {
    ...
    var map = "function" == typeof Map ? new Map : function() {
            var keys = [],
                values = [];
            return {
                has: function(key) {
                ...
                set: function(key, value) {
                    keys.indexOf(key) === -1 && (keys.push(key), values.push(value))
                },
                "delete": function(key) {
                    var index = keys.indexOf(key);
                    index > -1 && (keys.splice(index, 1), values.splice(index, 1))
                }
            }
        }(),
